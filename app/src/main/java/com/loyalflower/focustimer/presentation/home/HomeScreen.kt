...
import com.loyalflower.focustimer.R
import com.loyalflower.focustimer.domain.model.TimerTypeEnum
import com.loyalflower.focustimer.presentation.components.AutoResizedText
import com.loyalflower.focustimer.presentation.components.BorderedIcon
import com.loyalflower.focustimer.presentation.components.CircleDot
import com.loyalflower.focustimer.presentation.components.CustomButton
import com.loyalflower.focustimer.presentation.components.InformationItem
import com.loyalflower.focustimer.presentation.components.TimerTypeItem
...
fun HomeScreen(viewModel: HomeScreenViewModel = hiltViewModel()) {
    ...
    val timerStartState by remember { mutableStateOf(viewModel.isTimerActiveState) }
    ...
    Column(
        ...
        Column(
            ...
            CustomButton(
                text = if(timerStartState.value) "Pause" else "Start",
                textColor = MaterialTheme.colorScheme.surface,
                buttonColor = MaterialTheme.colorScheme.primary,
                onTap = {
                    if(timerStartState.value) viewModel.onCancleTimer(reset = false) else viewModel.onStartTimer()
                }
            )
            CustomButton(
                text = "Reset",
                ...
                onTap = {
                    viewModel.onCancleTimer(reset = true)
                }
            )
        }
        Spacer(modifier = Modifier.height(FocusTimerTheme.dimens.spacerMedium))
...
@Preview(
    name = "HomeScreenPriview", showBackground = true
)
@Composable
fun HomeScreenPriview() {
    FocusTimerTheme {
        HomeScreen()
    }
}